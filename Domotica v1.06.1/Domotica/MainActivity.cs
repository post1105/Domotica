...
namespace Domotica
{
    ...
    public class MainActivity : Activity
    {
        ...
        EditText editTextIPAddress, editTextIPPort, editTextDrukTres, editTextLichtTres;

        Timer timerClock, timerSockets, timerSensors;             // Timers   
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            textViewSensor2Value = FindViewById<TextView>(Resource.Id.textViewSensor2Value);
        ...
        public void UpdateGUI(string result, TextView textview)
        {
            RunOnUiThread(() =>
            {
                if (result == "OFF") textViewChangePinStateValue.SetTextColor(Color.Red);
                else if (result == " ON") textViewChangePinStateValue.SetTextColor(Color.Green);
                else textViewChangePinStateValue.SetTextColor(Color.White);
                if (result == "OFF") { textViewChangePinStateValue.Text = "OFF"; }
                if (result == " ON") { textViewChangePinStateValue.Text = " ON"; }
                if (result == "UIT") textViewChangePin2StateValue.SetTextColor(Color.Red);
                else if (result == "AAN") textViewChangePin2StateValue.SetTextColor(Color.Green);
                else textViewChangePin2StateValue.SetTextColor(Color.White);
                if (result == "UIT") { textViewChangePin2StateValue.Text = "OFF"; }
                if (result == "AAN") { textViewChangePin2StateValue.Text = " ON"; }
                if (result == "NEE") textViewChangePin3StateValue.SetTextColor(Color.Red);
                else if (result == " JA") textViewChangePin3StateValue.SetTextColor(Color.Green);
                else textViewChangePin3StateValue.SetTextColor(Color.White);
                if (result == "NEE") { textViewChangePin3StateValue.Text = "OFF"; }
                if (result == " JA") { textViewChangePin3StateValue.Text = " ON"; }
            });
        }
