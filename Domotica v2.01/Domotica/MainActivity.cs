...
namespace Domotica
{
    ...
    public class MainActivity : Activity
    {
        ...
        EditText editTextIPAddress, editTextIPPort, editTextLichtTres, editTextTime;

        Timer timerClock, timerSockets, timerTimer /*timerSensors*/;             // Timers   
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            timerTimer = new System.Timers.Timer() { Interval = 1000, Enabled = true };
